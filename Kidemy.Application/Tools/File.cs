...
namespace Kidemy.Application.Tools
{
	public static class FileTools
	{
		...
		public const int ImageMinimumBytes = 100;
		...
		public static void AddImageToServerWithOutThumb(this IFormFile image, string fileName, string originalPath, int? width,
		...
		{
			if ((!string.IsNullOrEmpty(imageName)) && imageName != SiteTools.DefaultImageName)
			{
				originalPath = Directory.GetCurrentDirectory() + "wwwroot" + originalPath;
				thumbPath = Directory.GetCurrentDirectory() + "wwwroot" + thumbPath;
