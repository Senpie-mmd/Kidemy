...
{
    public class AdminSideUpdateCourseViewModel : LocalizableViewModel<LocalizedAdminSideUpdateCourseViewModel>
    {
        public AdminSideUpdateCourseViewModel()
        {
            UploadedCourseImage = SiteTools.DefaultImageName;
        }
        ...
        public string? UploadedCourseImage { get; set; }
    ...
    public class LocalizedAdminSideUpdateCourseViewModel : LocalizedViewModel
    {
        [Display(Name = "Title")]
        public string? Title { get; set; }
