...
{
    public class AdminSideCreateCourseVideoViewModel : LocalizableViewModel<LocalizedAdminSideCreateCourseVideoViewModel>
    {
        ...
        public bool CanShowIsFreeOption { get; set; } = true;
    }

    public class LocalizedAdminSideCreateCourseVideoViewModel : LocalizedViewModel
    {
        [Display(Name = "Title")]
        public string? Title { get; set; }
    }
